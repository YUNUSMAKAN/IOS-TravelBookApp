...
//  TravelBook
//
//  Created by MAKAN on 17.04.2020.
...
class ViewController: UIViewController, MKMapViewDelegate,CLLocationManagerDelegate{
    ...
    override func viewDidLoad() {
        ...
        if selectedTitle != ""{
            ...
            fetchRequest.predicate = NSPredicate(format: "id = %Q", idString)
    ...
    @objc func choosenLocation(gestureRecognizer : UILongPressGestureRecognizer){
        ...
        if gestureRecognizer.state == .began {
            ...
            annotation.title = nameText.text      // isim verdik
            annotation.subtitle = commentText.text  // altyazi ekledik
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        // istedigimiz degerleri core data ya kaydettik.
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let context = appDelegate.persistentContainer.viewContext
